                ...
                <div class=" space-y-8 divide-gray-200 w-1/2 mt-10">
                    <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="name" name="name" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2">
                            </div>
                        </div>
                        <div sm:col-span-6>
                        ...
                        <div sm:col-span-6 pt-5>
                            ...
                            <div class="mt-1">
                                <input type="number" min="0.00" max="10000.00" step="0.01" id="price" name="price" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2">
                            </div>
                        </div>
                        <div sm:col-span-6 pt-5>
                            <label for="title" class="block text-sm font-medium text-gray-700">Description</label>
                            <div class="mt-1">
                                <textarea id="body" rows="3" name="description" class="shadow-sm w-full focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2"></textarea>
                            </div>
                        </div>
                        <div sm:col-span-6 pt-5>
