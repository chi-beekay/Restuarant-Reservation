                ...
                <div class=" space-y-8 divide-gray-200 w-1/2 mt-10">
                    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="title" name="name" class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2" value="{{ $category->name }}">
                            </div>
                        </div>
                        <div sm:col-span-6>
                        ...
                        <div sm:col-span-6 pt-5>
                            ...
                            <div class="mt-1">
                                <textarea id="description" rows="3" name="description" class="shadow-sm w-full focus:ring-indigo-500 appearance-none bg-white border border-gray-400 rounded-md py-2">{{ $category->description }}</textarea>
                            </div>
                        </div>
                        <div class=" mt-6 p-4">
